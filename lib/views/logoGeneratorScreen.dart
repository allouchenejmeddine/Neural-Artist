...
class LogoGenerator extends StatefulWidget {
  const LogoGenerator({Key? key}) : super(key: key);
                            ...
                            children: [
                              TextField(
                                ...
                                decoration: InputDecoration(
                                    ...
                                    hintText: "Example : Logo of a fast food named Bake&Bake",
                              ...
                              DropdownButton(
                                ...
                                items: const [
                                  DropdownMenuItem(
                                      value : "256",
                                      child: Text("Logo of 256*256")
                                  ),
                                  DropdownMenuItem(
                                      value : "512",
                                      child: Text("Logo of 512*512")
                                  ),
                                  DropdownMenuItem(
                                      value : "1024",
                                      child: Text("Logo of 1024*1024")
                                  ),
                                ],
